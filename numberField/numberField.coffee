...
do ($ = jQuery) ->
	methods = 
		init : () ->
			...
			field.keydown ( event ) ->
				# Allow: shift 16, backspace 46, delete 8, tab 9, escape 27, enter 13, plus 107, minus 109, dot 110, decimal dot 118, 188
				if ( event.keyCode in [16, 46, 8, 9, 27, 13, 107, 109, 110, 118, 188] ||
					# Allow: Ctrl+A
